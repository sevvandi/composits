...
#' animate_ts_ensemble(out2, max_frames = 10)
#' }
#'
#' @export
animate_ts_ensemble <- function(obj=NULL, X = NULL, max_frames = Inf){
  ...
  tourr::animate_xy(X, col=col, axes="off", max_frames = max_frames)
}
